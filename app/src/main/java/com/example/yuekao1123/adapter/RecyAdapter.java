package com.example.yuekao1123.adapter;
...
import com.example.yuekao1123.CustomJiaJian.CustomJiaJian;
import com.example.yuekao1123.R;
...
public class RecyAdapter extends RecyclerView.Adapter<RecyAdapter.MyViewHolder>{
     ...
     * 添加数据并更新显示
     * */
    public void add(ShopBean cartBean){
        //传进来的是bean对象
        if(list == null){
            list = new ArrayList<>();
        }
        //第一层遍历商家和商品
        for (ShopBean.DataBean shop : cartBean.getData()){
